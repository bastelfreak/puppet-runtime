platform 'windowsfips-2016-x64' do |plat|
  ...
  packages = [
    'cmake',
    "pl-gdbm-#{_platform.architecture}",
    "pl-iconv-#{_platform.architecture}",
    "pl-libffi-#{_platform.architecture}",
    "pl-pdcurses-#{_platform.architecture}",
    "pl-toolchain-#{_platform.architecture}",
    "pl-zlib-#{_platform.architecture}",
